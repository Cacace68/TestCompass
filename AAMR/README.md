...
The tester creates or imports a model
AAMR analyses the model’s structure and semantics
AAMR generates targeted questions and observations
The tester reviews and responds
The model is refined and strengthened
